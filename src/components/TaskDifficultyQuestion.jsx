        ...
        <div className="border-4 border-black rounded-xl p-8 bg-white shadow-lg relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="text-sm font-mono normal-case">For Loop</div>
            </button>
          </div>
        </div>
        ...
        {showTellMe2 && (
          <div className="border-4 border-black rounded-xl p-6 bg-white shadow-lg">
            ...
            <div className="text-lg leading-relaxed text-black">
              ...
              understanding
              <span className="font-bold bg-yellow-200 px-1 rounded ml-1">
                multiple concepts or skills working together
              </span>
              : loop syntax, the range() function, variable accumulation, and
              logical flow control. All of these skills have their own inherent
              difficulty in AFM and add up to make the task more difficult.
            </div>
            <div className="mt-4 text-lg leading-relaxed text-black">
              Variable declaration is more straightforward - it's just
              <span className="font-bold bg-green-200 px-1 rounded ml-1">
                assigning values to names
              </span>
              . In contrast, "for-loops" require understanding how iteration
              works and how to maintain state across multiple iterations, making
              it
              <span className="font-bold bg-red-200 px-1 rounded ml-1">
