...
export const LearningOpportunityChoices = ({ navigate, onChoiceClick }) => {
  ...
  const handleOpportunityChoice = (choice) => {
    ...
    // Call the callback to notify parent that a choice was clicked
    if (onChoiceClick) {
      onChoiceClick();
    }
  };
        ...
        <div className="border-4 border-black rounded-xl p-6 bg-gradient-to-r from-blue-100 to-purple-100 shadow-lg relative">
          ...
          <div className="text-center space-y-4">
            <h2 className="text-2xl font-bold text-black tracking-tight leading-tight">
              How do you think your practice opportunities changed from the
          ...
          <div className="border-l-8 border-green-600 bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-6 shadow-lg animate-fadeIn">
            ...
            <div className="bg-white border-2 border-black rounded-lg p-4">
              <p className="text-black leading-relaxed font-mono">
                ...
                in{" "}
                <span className="bg-blue-200 px-1 font-bold">
                  Index Slicing in Python
                </span>
                . After the second question, you had{" "}
                <span className="bg-yellow-300 px-1 font-bold">
                  2 opportunities
                </span>{" "}
                in that same skill. Each time you work on a task for a{" "}
                <span className="bg-green-200 px-1 font-bold">
                  specific skill
                </span>
                , your opportunities in that skill{" "}
                <span className="bg-yellow-300 px-1 font-bold">
                  increase by 1
                </span>
                . However, your opportunities in{" "}
                <span className="bg-red-200 px-1 font-bold">
                  different skills
                </span>{" "}
                (like loops or functions) remain the same, as tasks are{" "}
                <span className="bg-green-200 px-1 font-bold">
                  skill-specific
                </span>
                .
                <br />
                <br />
                <span className="bg-purple-200 px-1 font-bold">AFM</span>{" "}
                estimates the{" "}
                <span className="bg-orange-200 px-1 font-bold">
                  probability
                </span>{" "}
                that a student answers the next task on a specific skill
                correctly.
              </p>
            </div>
          </div>
