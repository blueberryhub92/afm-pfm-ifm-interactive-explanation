      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <button
            ...
            className={`border-4 border-black rounded-xl p-8 transition-all font-bold text-xl uppercase tracking-wider shadow-lg hover:shadow-xl transform hover:-translate-y-1 ${
              taskChoice === "A"
        ...
        {showTaskResult2 && (
          <div className={`border-4 rounded-xl p-8 shadow-lg animate-pulse relative ${
            ...
            <div className={`absolute -top-6 left-4 px-3 py-1 font-semibold rounded-md text-xs tracking-wider flex items-center gap-2 text-white ${
            ...
            <div className="text-center mb-6">
              <div className={`text-3xl font-black mb-4 uppercase tracking-wider ${
              ...
              {isCorrect ? (
                <>
                  <div className="text-xl font-bold text-black mb-4">
                    **Task A (List Manipulation)** typically has a much faster learning rate.
                  </div>
                ...
                <>
                  <div className="text-xl font-bold text-black mb-4">
                    **Task A (List Manipulation)** actually has the faster learning rate.
                  </div>
