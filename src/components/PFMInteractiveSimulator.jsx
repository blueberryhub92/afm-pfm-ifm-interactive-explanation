        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="border-4 border-black rounded-xl p-8 bg-white shadow-lg">
            <p className="text-lg text-black leading-relaxed text-center">
              Watch your <strong>actual PFM learning path</strong> unfold in
              real-time! No predictions, no assumptions - just your genuine
              learning journey based on your responses.
              <br />
              <strong>Real-Time Insight:</strong> See how each success or
              failure immediately affects your probability trajectory.
            </p>
          </div>
                ...
                {!sessionActive && retrainingData.length > 0 && (
                  <div className="border-4 border-yellow-600 rounded-xl p-6 bg-yellow-100 mb-6">
                    ...
                    <p className="text-yellow-800 font-bold mb-4">
                      ...
                      update PFM parameters based on your success/failure
                      patterns.
                    </p>
                    <button
