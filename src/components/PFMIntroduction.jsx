        ...
        <div className="space-y-6">
          <div className="border-l-8 border-purple-600 bg-purple-100 p-6 rounded-r-xl">
            <p className="text-black text-xl font-bold leading-relaxed">
              ...
              . While they look similar at first glance, PFM has a crucial
              innovation.
            </p>
          </div>
          ...
          <div className="border-4 border-gray-600 rounded-xl p-6 bg-gray-50">
            ...
            <div className="bg-black text-green-400 p-6 rounded-lg border-4 border-gray-600 font-mono text-lg text-center">
              <div className="text-white font-bold">
                log(p/(1-p)) = θᵢ + Σₖ qⱼₖ(βₖ +{" "}
                <span className="bg-purple-600 px-3 py-2 rounded text-white font-bold">
                  learning terms
                </span>
                )
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border-4 border-green-600 rounded-xl p-6 bg-green-50">
              ...
              <div className="border-4 border-green-600 rounded-xl p-4 bg-white">
                ...
                <p className="text-black font-bold text-lg leading-relaxed">
                  ...
                  – whether you get a question right or wrong, it counts as ONE
            ...
            <div className="border-4 border-purple-600 rounded-xl p-6 bg-purple-50">
              ...
              <div className="border-4 border-purple-600 rounded-xl p-4 bg-white">
                <h4 className="font-bold text-purple-700 text-lg uppercase tracking-wide mb-3">
                  Separate Learning
                </h4>
                <p className="text-black font-bold text-lg leading-relaxed">
                  PFM recognizes:{" "}
                  <em>we might learn differently from successes vs failures</em>
                  . Uses separate{" "}
                  <span
                    ref={gammaRef}
        ...
        <div className="space-y-6">
          <div className="border-4 border-orange-600 rounded-xl p-6 bg-orange-50">
            ...
            <p className="text-black text-lg font-bold leading-relaxed">
              For some skills, you might learn MORE from mistakes (like
              debugging code), while for others, you learn more from successful
              repetition (like writing correct Python syntax).
            </p>
          </div>
          ...
          <div className="border-4 border-blue-600 rounded-xl p-6 bg-blue-50">
            ...
            <p className="text-black text-lg font-bold leading-relaxed">
              This separation allows PFM to capture more nuanced learning
              patterns. The model can make different predictions based on
              whether students learn more from their successes or their
              mistakes.
            </p>
          </div>
        </div>
    ...
    >
      ...
      <div className="space-y-3 text-sm text-black">
        ...
        <div className="border-l-4 border-green-600 bg-green-100 px-4 py-2 rounded-r-lg">
          <strong className="text-black font-bold">γₖˢᵘᶜᶜ:</strong>{" "}
        ...
        <div className="border-l-4 border-red-600 bg-red-100 px-4 py-2 rounded-r-lg">
          <strong className="text-black font-bold">γₖᶠᵃⁱˡ:</strong>{" "}
    ...
    >
      <div className="border-4 border-purple-600 rounded-xl p-4 bg-purple-50 mb-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="font-bold text-purple-700 uppercase tracking-wide text-lg">
            Separate Gamma Values
          </span>
        </div>
      </div>
      ...
      <div className="border-4 border-yellow-600 rounded-xl p-4 bg-yellow-50 mt-4">
        ...
        <div className="text-black font-bold text-sm">
          Debugging: Learn MORE from failures (γᶠᵃⁱˡ = -0.3) than successes
          (γˢᵘᶜᶜ = 0.1)
        </div>
      </div>
    </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-between items-center">
            ...
            {currentStep < steps.length - 1 ? (
              ...
              >
                <span>Discover the PFM in Action</span>
